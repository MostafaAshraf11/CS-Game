...
public class Army{
	...
	public String toString() {
		...
		String s = this.currentStatus.toString() + ", Location: " + this.currentLocation;
		s+= ", Target:" + this.getTarget() + ", Distance to target:" + this.distancetoTarget + ", ";
