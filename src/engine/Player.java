...
public void downgradeBuilding(ArcheryRange b) throws BuildingInCoolDownException,MinLevelException,DowngradeLimitExeption {
	
	if (b.getLevel()==1)
		throw new MinLevelException();
	else {if (b.getLevel() == 2) {
b.downgrade();
setTreasury	(getTreasury()+b.getDowngradeGoldBack());}
	else{
	b.downgrade();
	setTreasury	(getTreasury()+b.getDowngradeGoldBack());
	}
